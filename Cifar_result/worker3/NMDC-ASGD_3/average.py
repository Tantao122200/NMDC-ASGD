...
if __name__ == "__main__":
    mypath("./msg")
    in_dir = ["./data/train_ASGDMT_0.1_62400_128_3_", "./data/test_ASGDMT_0.1_62400_128_3_"]
    out_dir = ["./msg/train_ASGDMT_0.1_62400_128_3.csv", "./msg/test_ASGDMT_0.1_62400_128_3.csv"]
