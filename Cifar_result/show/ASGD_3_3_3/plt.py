...
if __name__ == "__main__":
    path = "./train/ASGD_3_3_3/"
    mypath(path=path)

    train_result = pd.read_csv("./train_ASGD_0.1_62400_128_3.csv", header=None, usecols=[0, 2, 3, 5, 6]).values.T
    picture("train", train_result[0][40:], train_result[1][40:], train_result[2][40:], train_result[3][40:],
            train_result[4][40:],
            "ASGD_3")
    ...
    # path = "./test/ASGD_3_3_3/"
    # mypath(path=path)
    #
    # train_result = pd.read_csv("./test_ASGD_0.1_62400_128_3.csv", header=None, usecols=[0, 2, 3, 5, 6]).values.T
    # picture("test", train_result[0][40:], train_result[1][40:], train_result[2][40:], train_result[3][40:], train_result[4][40:],
    #         "ASGD_3")
